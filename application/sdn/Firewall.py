...
class Firewall(LearningSwitch):
    ...
    def __init__(self, connection):
        ...
        self.icmprules = {}
        self.arprules = {}
        self.DNSpool = (IPAddr('100.0.0.20'),IPAddr('100.0.0.21'),IPAddr('100.0.0.22'))
        self.Webpool = (IPAddr('100.0.0.40'),IPAddr('100.0.0.41'),IPAddr('100.0.0.42'))
        self.Publicpool = (IPAddr('100.0.0.12'),IPAddr('100.0.0.11'))
        self.Privatepool = (IPAddr('100.0.0.51'),IPAddr('100.0.0.52'))
